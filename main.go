...
func main() {
	...
	app.Action = func(cctx *cli.Context) error {
		...
		s.Node.ArEngine, err = autoretrieve.NewAutoretrieveEngine(stopArEngineCh, time.Duration(intervalMinutes)*time.Second, s.DB) // TODO: change time.Second to time.Minute
		if err != nil {
			return err
		}
